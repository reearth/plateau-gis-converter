...
`nusamai-projection` には、国土地理院が公表している以下のデータを、値を変えずに独自のバイナリ形式へ変換したものを同梱しています。

- 「測地成果2024移行のための水準点標高補正パラメータ」（`hyokorevBM_jgd2024_h.par`、Ver.1.0.0、公表日 令和7年4月1日）
- 「測地成果2024移行のための三角点標高補正パラメータ」（`hyokorevTR_jgd2024_h.par`、Ver.1.0.0、公表日 令和7年4月1日）

出典：国土地理院ウェブサイト「[座標標高補正パラメータファイル一覧](https://www.gsi.go.jp/sokuchikijun/sokuchikijun41012.html)」を加工して作成。
利用条件は[国土地理院コンテンツ利用規約](https://www.gsi.go.jp/kikakuchousei/kikakuchousei40182.html)に従います。

ジオイド・モデル（日本のジオイド2011、ジオイド2024日本とその周辺、基準面補正パラメータ）は依存クレート [japan-geoid](https://github.com/ciscorn/japan-geoid) が同梱しているものを利用しています。
